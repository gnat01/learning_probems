...
- `bash src/run_invisible_palette_toolkit.sh`
- `bash src/run_invisible_palette_toolkit_with_gif.sh`
- `bash src/run_invisible_palette_joint_toolkit_with_gif.sh`
- `bash src/run_invisible_palette_policy_toolkit.sh`
