...
The GIF script supports all flags from `src/invisible_palette_toolkit.py`, plus:
...
- full `src/invisible_palette_toolkit_with_gif.py` runs to still take noticeably longer.
